...
<div class="max-w-xl mx-auto px-4 sm:px-6 py-6 space-y-6" style="min-height:100vh;">
    ...
    <div class="flex items-center gap-3 mb-6">
        ...
        <h1 class="text-2xl font-bold tracking-tight" style="color:#0d0d0d;">Edit Commission Price</h1>
    </div>
    ...
    <form action="{{ route('admin.prices.update', $price) }}"
        ...
        <div class="flex items-center gap-3 p-4 rounded-xl" style="background:#f8f8f8;border:1px solid #ebebeb;">
            ...
            >
            <label for="is_active" class="text-sm font-semibold cursor-pointer" style="color:#333;">
                Active
            </label>
