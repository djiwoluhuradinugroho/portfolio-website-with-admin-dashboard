...
<div class="max-w-xl mx-auto p-6 space-y-6">
    ...
    <div class="flex items-center gap-3 mb-6">
        ...
        <h1 class="text-3xl font-bold bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent">Edit Commission Price</h1>
    </div>
    ...
    <form action="{{ route('admin.prices.update', $price) }}"
        ...
        <div>
            ...
            <div class="relative">
                ...
                <input
                    type="number"
                    name="price_from"
                    value="{{ old('price_from', $price->price_from) }}"
        ...
        <div>
            ...
            <div class="relative">
                ...
                <input
                    type="number"
                    name="price_to"
                    value="{{ old('price_to', $price->price_to) }}"
                    class="w-full border-2 border-gray-200 rounded-xl pl-8 pr-4 py-3 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all duration-200"
                    placeholder="100"
                >
            </div>
        ...
        <div class="flex items-center gap-3 bg-gradient-to-r from-purple-50 to-pink-50 p-4 rounded-xl border border-purple-100">
            <input
                type="checkbox"
                name="is_active"
                value="1"
            ...
            >
            <label class="text-sm font-semibold text-gray-700 cursor-pointer">Active</label>
        </div>
